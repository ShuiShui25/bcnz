...
def load_coadd_file(coadd_file):
    """Load PAUS narrow-band coadds from a CSV file.

    Fluxes and flux errors are preserved in the units supplied by the input
    catalogue; no implicit photometric rescaling is applied.
